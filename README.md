...
#  import the defineConfig function from Vite to define our configuration.

# also import the resolve function from the Node.js path module to resolve file paths.

# export a default configuration object using defineConfig.
